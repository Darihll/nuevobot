...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if username == tl_admin_user or tl_admin_user=='*' or user_info :  # validate user
            ...
            mensaje = "❌No tienes Acceso❌.\nPor favor Contacta con mi Programador @David_7amayo\n"
        ...
        if '/start' in msgText:
            start_msg = '📦 Versión 1.3.7 Release ⛩\n\n'
            start_msg+= '👤╭─────👋🏻 @' + str(username)+'\n│\n'
            start_msg+= '🤖├Bot que permite borrar de:\n│\n'
            start_msg+= '1️⃣├ /uclv\n'
            start_msg+= '2️⃣├ /eva\n'
            start_msg+= '3️⃣├ /cursos\n'
            start_msg+= '4️⃣├ /posgrado\n'              
            start_msg+= '5️⃣├ /aulacened\n'
            start_msg+= '6️⃣├ /eduvirtual\n'
